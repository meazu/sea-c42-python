...
#Function definition get_list_of_donars takes donation list as argument and retuns the donars list
...
#Function definition add_donar takes donation list and name of the new donar, adds and returns the donation list
def add_donar(list, name):
    list.append([name,[]])
    return list

#Function add_amount takes donation list, name of the donar and amont he is donating. It includes the value and returns true.
...
#Function print_report takes donation_list as an argument and returns the list of computed values as a string per donar.
    ...
    while var_quit == True:
        ...
        if prompt.upper() == 'T':        
            ...
            if prompt_t.lower() == 'list':
                ...
                if is_name_found(donation_list, prompt_t) == True: 
